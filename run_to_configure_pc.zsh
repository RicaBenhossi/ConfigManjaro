...
echo
# Variables
config_folder="/home/$USER/MyConfigss/Configs"
...
echo
echo "*** It will ask for Github\'s username and password or token."
...
# rm -f ~/.p10k.zsh;
mkdir -p ~/.config/nvim;
ln -s $config_folder/.zshrc_starship ~/.zshrc;
...
ln -s $config_folder/starship.toml ~/.config/starship.toml
echo
...
ln -s ~/MyConfigss/Configs/gtk-3.0-gtk.css ~/.config/gtk-3.0/gtk.css
echo
...
echo
echo 'Press any key to continue...'; read -k1 -s
dconf load /org/gnome/terminal/legacy/profiles:/ < ~/MyConfigs/gnome-extensions/gnome-terminal-profiles.dconf
echo
